      ...
      <div className="App">
        ...
        <div className="App-body">
          ...
          <ul>
            ...
            <ul>
              <li>
                <a href="http://hpe.com/">Hewlett-Packard Enterprise (HPE)</a> (current employer)
              </li>
              <li>
          ...
          <ul>
            <li>
              React -- Started holding weekly brown-bag training meetings
              about React, Grommet, and Redux in 2017.
              Helped co-worker port legacy JavaScript charting
              website to React.
              This website is developed with React and Grommet 2.
            </li>
            <li>
            ...
            <li>
              C# -- At Hewlett-Packard in San Diego, I led the effort in designing and
              implementing a new dependency based build system in the All-in-One
              (printer/fax/scanner) group in C#.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              I helped a co-worker port a legacy JavaScript charting website to React.
            </li>
            <li>
              This website is developed with React and Grommet 2.
            </li>
          ...
          <ul>
            ...
            <li>
              ...
              versions. The Hewlett-Packard Storage lab test leads got together to give input
              on their biggest pain-points, and the biggest issue they mentioned
              was updating the firmware and drivers for the fibre channel cards
              (or HBA's--Host Bus Adapters) on their hundreds of computers. I
              volunteered to develop a tool to automate the upgrading of their
              systems. LabMan (Lab Manager) was born. The back-end was written
              in Python. Its purpose was to keep a list of servers, and to
              detect information about them. If they need newer Fibre Channel
              drivers or firmware, it will crawl the web, find the software on
              Hewlett-Packard's website, download it, cache it, and install the software. It does
              this across multiple systems in parallel, via ssh. No client-side
              setup is required. LabMan installs the needed 3rd party tools
              (command-line versions) for updating the software.
              <ul>
                <li>
              ...
              <img src="./images/labman3.png" alt="labman3 screenshot"/>
              <br />
              ...
              <ul>
                ...
                <li>
                  ...
                  <a href="https://support.hpe.com/hpsc/doc/public/display?sp4ts.oid=412183&docId=emr_na-c03672405&docLocale=en_US">EBS Matrix.</a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              Helett-Packard WSDL Service Composer -- WSDL Schema editor developed in
              Java/JGo
            </li>

            <img src="./images/ServiceComposer.jpg" width="716" height="657" alt="service composer screenshot"/>
          ...
          <ul>
            ...
            alt="nokia image"/>
            <img
              src="./images/JavaME.gif"
              style="position: relative; left: 394px; top: 88px; z-index:-1"
              align="left"
              width="154"
              height="188"
              alt="JavaME"
...
*/}
          ...
          <ul>
            ...
            <li>
              ...
              or firmware, it will crawl the web, find the software on Hewlett-Packard's website,
              download it, cache it, and install the software. It does this
              across multiple systems in parallel, via ssh. No client-side setup
              is required. LabMan installs the needed 3rd party tools
              (command-line versions) for updating the software.
            </li>
            ...
            <img src="./images/labman.jpg" width="1154" height="444" alt="labman screenshot"/>
            <br />
            ...
            <li>
              ...
              -- While at Hewlett-Packard in San Diego, I helped build a second-generation
              dependency based build environment in Python, when a new manager
              introduced our team to the language.
            </li>
          </ul>
          ...
          <ul>
            ...
            <img src="./images/healthMonitor.png" alt="health monitor screenshot"/>
            <li>
          ...
          <ul>
            ...
            <img src="./images/OpenStudio.jpg" width="660" height="478" alt="OpenStudio screenshot"/>
            ...
            <img src="./images/Waterford.jpg" width="480" height="360" alt="Waterford Logo"/>
            <li>
              Back in 1998 I joined Hewlett-Packard on the Ignite-UX team (the HP-UX install
              tool), and worked in C as well as Unix Scripting...
            </li>
            <img src="./images/ignite-ux.jpg" width="459" height="276" alt="Ignite-UX screenshot"/>
          </ul>
          ...
          <ul>
            <li>HPE OneView's GUI front-end, in JQuery and JavaScript.</li>
            <li>
            ...
            <img src="./images/redbox_ss.png" alt="RedBox App screenshot"/>
          </ul>
          ...
          <ul>
            <li>
              C# -- At Hewlett-Packard in San Diego, I led the effort in designing and
              implementing a new dependency based build system in the All-in-One
              (printer/fax/scanner) group in C#. The build team had a legacy
              system where over 100 modules were built in sequence, dependent
              upon all modules before it being built. I designed and implemented
              a new build environment that relied on dependencies between
              modules to allow single modules to be built, including the modules
              they depended upon.
            </li>
          </ul>
          ...
          <ul>
            ...
            <img src="./images/android.png" width="320" height="480" alt="androind screenshot" />
          </ul>
          ...
          <ul>
            ...
            <img src="./images/ios.jpeg" width="320" height="480" alt="iOS screenshot" />
          </ul>
          ...
          <ul>
            ...
            <img src="./images/Windows8.jpg" width="700" height="320" alt="Windows8 screenshot" />
          </ul>
          ...
          <img
            src="./images/JavaME.gif"
            style="position: relative; left: 394px; top: 88px;"
            align="left"
            width="154"
            height="188"
          alt="JavaME Logo" />
          <img
            ...
            width="212"
            height="479"
          alt="Nokia screenshot" />
          <img
            src="./images/nokia.gif"
            style="position: relative; left: 210px; top: 0px;"
            align="left"
            width="212"
            height="479"
          alt="Nokia screenshot" />
*/}
          ...
          <ul>
            ...
            <a name="hpux" />
             */}
            <li>Windows -- Use at home and at work</li>
            <li>Linux -- Use mostly Red Hat at work. Some Ubuntu, SuSE.</li>
            <li>HP-UX -- 1989-- HP-UX's Ignite-UX (install) team.</li>
          </ul>

          <h2>
            <a name="vmware">Virtualization</a>
          </h2>
